...
test('no shebang', function (t) {
  var src = path.resolve(fixtures, 'src.exe')
...
test('env shebang', function (t) {
  var src = path.resolve(fixtures, 'src.env')
...
test('env shebang with args', function (t) {
  var src = path.resolve(fixtures, 'src.env.args')
...
test('explicit shebang', function (t) {
  var src = path.resolve(fixtures, 'src.sh')
...
test('explicit shebang with args', function (t) {
  var src = path.resolve(fixtures, 'src.sh.args')
